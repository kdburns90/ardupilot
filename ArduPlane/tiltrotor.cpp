...
void QuadPlane::tiltrotor_vectored_yaw(void)
{
    ...
    */
    ...
    if (no_yaw) { // forward flight
        ...
        float yaw_range = zero_out - fabsf(pitch_out * pitch_range);
        
        SRV_Channels::set_output_scaled(SRV_Channel::k_tiltMotorFrontLeft,  1000 * (base_output + yaw_out * yaw_range - pitch_out * pitch_range));
        SRV_Channels::set_output_scaled(SRV_Channel::k_tiltMotorFrontRight, 1000 * (base_output - yaw_out * yaw_range - pitch_out * pitch_range));
        SRV_Channels::set_output_scaled(SRV_Channel::k_tiltMotorBackLeft,  1000 * (base_output + yaw_out * yaw_range - pitch_out * pitch_range));
        SRV_Channels::set_output_scaled(SRV_Channel::k_tiltMotorBackRight, 1000 * (base_output - yaw_out * yaw_range - pitch_out * pitch_range));
    }
}
