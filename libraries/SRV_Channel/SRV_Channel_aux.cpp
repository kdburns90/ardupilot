...
void SRV_Channel::aux_servo_function_setup(void)
{
    ...
    case k_tiltMotorFrontLeft:           ///< for aerduplane
    case k_tiltMotorFrontRight:           ///< for aerduplane
    case k_tiltMotorBackLeft:           ///< for aerduplane
    case k_tiltMotorBackRight:           ///< for aerduplane
    case k_elevon_left:
    case k_elevon_right:
    case k_vtail_left:
    case k_vtail_right:
    ...
    case k_throttleFrontLeft:           ///< for aerduplane
    case k_throttleFrontRight:           ///< for aerduplane
    case k_throttleBackLeft:           ///< for aerduplane
    case k_throttleBackRight:           ///< for aerduplane
        // fixed wing throttle
        set_range(100);
        break;
    default:
